      ...
      <div className="w-full max-w-md">
        <div className="bg-white/80 shadow-md border border-white/30 rounded-[30px] p-10 md:p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-500 mb-3">Forgot Password</h1>
            <p className="text-lg text-gray-400">Enter your email to receive a password reset link</p>
          </div>
